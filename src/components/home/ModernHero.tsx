  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute top-3/4 right-1/4 w-24 h-24 bg-secondary/10 rounded-full animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-1/4 left-1/3 w-16 h-16 bg-accent/20 rounded-full animate-float" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8 animate-scale-in">
            ...
            <span className="text-sm font-medium text-primary">Est. 2020 • NGO Registration: 00NGO/R/7452</span>
          </div>
          ...
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-poppins font-bold leading-tight mb-4">
              ...
              <span className="block text-shimmer animate-slide-in-right" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-slide-up" style={{ animationDelay: '0.9s' }}>
          ...
          {/* Impact Statistics */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto animate-scale-in" style={{ animationDelay: '1.2s' }}>
            {stats.map((stat, index) => (
              <div
                key={stat.label}
                className={`card-modern hover-lift group animate-fade-in stagger-${index + 1}`}
