        ...
        <div className='text-center mb-16'>
          <div className={`scroll-trigger ${isVisible ? "in-view" : ""}`}>
            ...
            <h2 className='text-4xl md:text-5xl lg:text-6xl font-poppins font-bold text-foreground mb-6'>
              Partners &{" "}
              <span className='text-gradient-secondary'>Sponsors</span>
            </h2>

            <p className='text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
              Working together with leading organizations, institutions, and
              corporations to amplify our impact and reach communities
              worldwide.
            </p>
          </div>
        </div>
        ...
        <div className={`scroll-trigger ${isVisible ? "in-view" : ""} mb-16`}>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
              Proud to collaborate with organizations that share our vision for
              global development and positive change.
            </p>
          </div>
        ...
        <div
          ...
          <div className='section-highlight rounded-3xl p-8 md:p-12'>
            ...
            <p className='text-lg text-muted-foreground mb-8 max-w-2xl mx-auto'>
              ...
              development solutions that transform communities worldwide.
            </p>
