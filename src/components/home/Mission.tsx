      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16 scroll-fade'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            We believe in the power of connection, education, and sustainable
            action to transform communities and create a more equitable world
            for all.
          </p>
        </div>
        ...
        <div className='card-elevated text-center mb-16 scroll-fade'>
          <div className='max-w-4xl mx-auto'>
            <h3 className='text-2xl lg:text-3xl font-poppins font-semibold mb-6 text-gradient-nature'>
              "To bridge communities across the globe through innovation,
              sustainable development and meaningful partinership that create
              lastingpostive impact."
            </h3>
            <p className='text-lg text-muted-foreground'>
              Every action we take is guided by our commitment to empowerment,
              inclusion, and the belief that together we can solve the world's
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          {values.map((value, index) => (
            <div
              ...
              <div
                className={`w-20 h-20 bg-${value.color} rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-glow transition-all duration-500`}>
        ...
        <div className='text-center mt-16 scroll-fade'>
          <div className='card-elevated inline-block'>
            ...
            <p className='text-muted-foreground mb-6'>
              Join our global community of changemakers and help us bridge the
              gap to a better tomorrow.
            </p>
