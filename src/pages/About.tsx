...
const About = () => {
  const team = [
    ...
    },
    {
      ...
      image: '/api/placeholder/300/300',
      bio: 'Building bridges between communities and organizations globally.',
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-fade">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Founded in 2020, Global Bridging Center for Shared Development (GBCSD) emerged from a 
                  powerful vision to foster collaboration, innovation, and sustainability across the globe. 
                  We unite diverse voices and expertise to tackle today's most pressing challenges.
                </p>
                <p>
                  Formally registered as a Non-Governmental Organization in Tanzania (00NGO/R/7452) in 2024, 
                  we are dedicated to empowering communities and driving inclusive progress that benefits 
                  both present and future generations.
                </p>
                <p>
                  At GBCSD, we empower individuals and communities by working with governments, civil societies 
                  and other stakeholders through collaboration and innovation to address global challenges and 
            ...
            <div className="card-elevated scroll-fade">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground">NGO Registered</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-nature mb-2">Global</div>
                  <div className="text-sm text-muted-foreground">Reach</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-trust mb-2">Unity</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="card-feature scroll-fade hover-lift">
              ...
              <p className="text-muted-foreground leading-relaxed">
                A world where every community has the resources, knowledge, and connections 
                needed to thrive sustainably and contribute to global prosperity.
              </p>
            </div>
            <div className="card-feature scroll-fade hover-lift">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-fade">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Passionate professionals dedicated to creating positive change in communities worldwide.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div key={member.name} className="card-feature text-center hover-lift scroll-fade">
                <div className="w-32 h-32 bg-gradient-hero rounded-full mx-auto mb-6 shadow-glow flex items-center justify-center">
